...
This does not look like a linear relationship at all. I tried to fit several models. First we tried the linear one as a baseline. This was actually pretty good, although the diagnostics don't look great.
...
I then tried a square root model. The R squared was much better, and the diagnostics look fantastic.
```{r}
